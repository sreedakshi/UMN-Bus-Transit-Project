...
public class MyWebServerSession {
  ...
  public void setmyWebServerSessionState(MyWebServerSessionState states) {
    this.state = states;
  }

  public void setMyWebServer(MyWebServer myws) {
    this.myWS = myws;
  }
  ...
  public void setVisualizationSimulator(VisualizationSimulator vs) {
    this.mySim = vs;
  }

  public MyWebServerSessionState getMyWebServerSessionState() {
    return state;
  }

  public MyWebServer getMyWebServer() {
    return myWS;
  }
